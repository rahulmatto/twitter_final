...
while True:
    user = api.get_user('rahulmatto')
    api.update_profile(name=f'rahul|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : rahul|{follower_count(user)} Followers')
